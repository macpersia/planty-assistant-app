...
abstract class BaseActivity : AppCompatActivity(), BaseListenerFragment.AvsListenerInterface {
    ...
    private fun sendPlaybackFinishedEvent(item: AvsItem?) {
        if (item != null) {
            val noOpCallback = object: AsyncCallback<AvsResponse, AvsResponseException> {
                override fun start() {
                ...
                override fun failure(error: AvsResponseException) {
                    TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
                }
    ...
    private fun checkQueue() {
        ...
        Log.i(TAG, "Item type " + current.javaClass.getName())
    ...
    companion object {
        ...
        private val STATE_PROCESSING = 2
        private val STATE_SPEAKING = 3
        private val STATE_PROMPTING = 4
        private val STATE_FINISHED = 0
