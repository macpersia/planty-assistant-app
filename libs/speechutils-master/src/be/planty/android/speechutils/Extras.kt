...
object Extras {
    ...
    val EXTRA_SERVER_URL = "ee.ioc.phon.android.extra.SERVER_URL"

    // GRAMMAR_URL should be a legal URL
    val EXTRA_GRAMMAR_URL = "ee.ioc.phon.android.extra.GRAMMAR_URL"

    // Identifier of the target language (any string)
    val EXTRA_GRAMMAR_TARGET_LANG = "ee.ioc.phon.android.extra.GRAMMAR_TARGET_LANG"

    // Desired transcription.
    // Using this extra, the user can specify to which string the enclosed audio
    // should be transcribed.
    val EXTRA_PHRASE = "ee.ioc.phon.android.extra.PHRASE"

    // Bundle with information about the editor in which the IME is running
    val EXTRA_EDITOR_INFO = "ee.ioc.phon.android.extra.EDITOR_INFO"

    // Boolean to indicate that the recognition service should not stop after delivering the first result
    val EXTRA_UNLIMITED_DURATION = "ee.ioc.phon.android.extra.UNLIMITED_DURATION"
    ...
    val EXTRA_SEMI_FINAL = "ee.ioc.phon.android.extra.SEMI_FINAL"
    ...
    val EXTRA_AUDIO_CUES = "ee.ioc.phon.android.extra.AUDIO_CUES"

    // Boolean. Use another app to view/evaluate/execute the recognition result. (Arvutaja-specific)
    val EXTRA_USE_EXTERNAL_EVALUATOR = "ee.ioc.phon.android.extra.USE_EXTERNAL_EVALUATOR"

    /**
     * Boolean.
     * Start the recognition session immediately without the user having to press a button.
     */
    val EXTRA_AUTO_START = "ee.ioc.phon.android.extra.AUTO_START"
     ...
     */
    val EXTRA_RETURN_ERRORS = "ee.ioc.phon.android.extra.RETURN_ERRORS"

    // Caller is interested in the recorded audio data (boolean)
    val EXTRA_GET_AUDIO = "android.speech.extra.GET_AUDIO"

    // Caller wants to have the audio data in a certain format (String)
    val EXTRA_GET_AUDIO_FORMAT = "android.speech.extra.GET_AUDIO_FORMAT"
    ...
    val EXTRA_DICTATION_MODE = "android.speech.extra.DICTATION_MODE"

    /**
     *
     * Key used to retrieve an `ArrayList<String>` from the [android.os.Bundle] passed to the
     * [android.speech.RecognitionListener.onResults] and
     * [android.speech.RecognitionListener.onPartialResults] methods.
     * This list represents structured data:
     *
     ...
     * Both of these bundle items have to be present for the client to be able to use the results.</Integer>
     */
    val RESULTS_RECOGNITION_LINEARIZATIONS = "ee.ioc.phon.android.extra.RESULTS_RECOGNITION_LINEARIZATIONS"
    val RESULTS_RECOGNITION_LINEARIZATION_COUNTS = "ee.ioc.phon.android.extra.RESULTS_RECOGNITION_LINEARIZATION_COUNTS"

    // Byte array. Currently not used.
    val RESULTS_AUDIO_ENCODED = "ee.ioc.phon.android.extra.RESULTS_AUDIO_ENCODED"

    // TODO: experimental
    val EXTRA_RESULT_PREFIX = "ee.ioc.phon.android.extra.RESULT_PREFIX"
    val EXTRA_RESULT_SUFFIX = "ee.ioc.phon.android.extra.RESULT_SUFFIX"

    val EXTRA_LAUNCH_RECOGNIZER = "ee.ioc.phon.android.extra.LAUNCH_RECOGNIZER"

    // API 14
    val ACTION_VOICE_SEARCH_HANDS_FREE = "android.speech.action.VOICE_SEARCH_HANDS_FREE"

    // A non-standard extra
    val EXTRA_ADDITIONAL_LANGUAGES = "android.speech.extra.EXTRA_ADDITIONAL_LANGUAGES"
