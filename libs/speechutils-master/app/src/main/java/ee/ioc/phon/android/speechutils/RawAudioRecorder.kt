 ...
 */
@JvmOverloads constructor(audioSource: Int = DEFAULT_AUDIO_SOURCE, sampleRate: Int = DEFAULT_SAMPLE_RATE) : AbstractAudioRecorder(audioSource, sampleRate) {

    val wsArgs: String
        get() = "?content-type=audio/x-raw,+layout=(string)interleaved,+rate=(int)" + getSampleRate() + ",+format=(string)S16LE,+channels=(int)1"
