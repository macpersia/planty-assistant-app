 ...
 */
class SpeechRecord @Throws(IllegalArgumentException::class)
@JvmOverloads constructor(audioSource: Int, sampleRateInHz: Int, channelConfig: Int, audioFormat: Int, bufferSizeInBytes: Int,
                          noise: Boolean = false, gain: Boolean = false, echo: Boolean = false) : AudioRecord(audioSource, sampleRateInHz, channelConfig, audioFormat, bufferSizeInBytes) {

    @Throws(IllegalArgumentException::class)
    constructor(sampleRateInHz: Int, bufferSizeInBytes: Int) : this(
    ...
    @Throws(IllegalArgumentException::class)
    constructor(sampleRateInHz: Int, bufferSizeInBytes: Int, noise: Boolean, gain: Boolean, echo: Boolean) : this(
            MediaRecorder.AudioSource.VOICE_RECOGNITION,
            sampleRateInHz,
            AudioFormat.CHANNEL_IN_MONO,
            AudioFormat.ENCODING_PCM_16BIT,
