...
abstract class SendEvent {
    ...
    /**
     * Get our JSON [com.willblaschko.android.alexa.data.Event] for this call
     * @return the JSON representation of the [com.willblaschko.android.alexa.data.Event]
     */
     ...
     * @param url the URL we're posting to, this is either the default [com.willblaschko.android.alexa.data.Directive] or [com.willblaschko.android.alexa.data.Event] URL
