...
object TokenManager {
     ...
     */
    fun getAccessToken(context: Context, authCode: String, codeVerifier: String, authorizationManager: AmazonAuthorizationManager, callback: TokenResponseCallback?) {
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                val tokenResponse = Gson().fromJson<TokenResponse>(s, TokenResponse::class.java!!)
     ...
     */
    fun getAccessToken(authorizationManager: AmazonAuthorizationManager, context: Context, callback: TokenCallback) {
     ...
     */
    private fun getRefreshToken(authorizationManager: AmazonAuthorizationManager, context: Context, callback: TokenCallback, refreshToken: String?) {
        //this url shouldn't be hardcoded, but it is, it's the Amazon auth access token endpoint
        val url = "https://api.amazon.com/auth/O2/token"
